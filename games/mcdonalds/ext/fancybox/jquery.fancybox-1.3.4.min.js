...
},u=function(){return[(window.innerWidth?window.innerWidth:B(window).width()),(window.innerHeight?window.innerHeight:B(window).height())-200,B(document).scrollLeft(),B(document).scrollTop()]
